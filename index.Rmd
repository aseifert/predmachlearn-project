...
This project builds a machine learning algorithm to predict activity quality from activity monitors. By creating a random forest model we achieve an accuracy of `0.991` (out of sample error `0.009`) on the validation set (60/40 split) and 100% accuracy on the test set.
